...
namespace Ground_Service_Control.AircraftGenerator {
    ...
    public partial class MapObject {
        ...
        public static implicit operator GMC.MapObject(MapObject d)
        {
            var mo = new GMC.MapObject()
            {
                MapObjectType = (GMC.MapObjectType) d.MapObjectType,
                Number = d.Number
            };
            return mo;
        }

        public static implicit operator MapObject(GMC.MapObject d)
        {
