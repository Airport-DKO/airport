...
namespace WeatherGUI.Weather {
    ...
    public partial class WebServiceWeather : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public double GetTemperature() {
            object[] results = this.Invoke("GetTemperature", new object[0]);
            return ((double)(results[0]));
        }
        
        /// <remarks/>
        public void GetTemperatureAsync() {
            this.GetTemperatureAsync(null);
        }
        
        /// <remarks/>
        public void GetTemperatureAsync(object userState) {
            ...
            this.InvokeAsync("GetTemperature", new object[0], this.GetTemperatureOperationCompleted, userState);
        }
