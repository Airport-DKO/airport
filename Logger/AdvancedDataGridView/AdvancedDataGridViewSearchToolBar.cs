...
namespace Zuby.ADGV
{
    ...
    public partial class AdvancedDataGridViewSearchToolBar : ToolStrip
    {
        ...
        public AdvancedDataGridViewSearchToolBar()
        {
            ...
            _textStrings.Add("LABELSEARCH", "Искать:");
            _textStrings.Add("BUTTONFROMBEGINTOOLTIP", "From Begin");
            _textStrings.Add("BUTTONCASESENSITIVETOOLTIP", "Чувствительность к регистру");
            _textStrings.Add("BUTTONSEARCHTOOLTIP", "Искать далее");
            _textStrings.Add("BUTTONCLOSETOOLTIP", "Скрыть");
            _textStrings.Add("BUTTONWHOLEWORDTOOLTIP", "Search only Whole Word");
            _textStrings.Add("COMBOBOXCOLUMNSALL", "(По всем колонкам)");
            _textStrings.Add("TEXTBOXSEARCHTOOLTIP", "Значение для поиска");

            //initialize components
            InitializeComponent();
            
            this.comboBox_columns.Items.AddRange(new object[] {
            _textStrings["COMBOBOXCOLUMNSALL"].ToString()});
            ...
            this.button_casesensitive.ToolTipText = _textStrings["BUTTONFROMBEGINTOOLTIP"].ToString();
